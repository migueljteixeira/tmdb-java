...
public class TvSeasonsServiceTest extends BaseTestCase {
    ...
    public void test_season() {
        Observable<TvSeason> season = getManager().tvSeasonsService().season(TestData.TVSHOW_ID, 1, null, null);

        season.toBlocking().forEach(new Action1<TvSeason>() {
            @Override
    ...
    public void test_season_with_append_to_response() {
        Observable<TvSeason> season = getManager().tvSeasonsService().season(TestData.TVSHOW_ID, 1, null,
    ...
    public void test_credits() {
        Observable<Credits> credits = getManager().tvSeasonsService().credits(TestData.TVSHOW_ID, 1);
    ...
    public void test_externalIds() {
        Observable<ExternalIds> ids = getManager().tvSeasonsService().externalIds(TestData.TVSHOW_ID, 1, null);
    ...
    public void test_images() {
        Observable<Images> images = getManager().tvSeasonsService().images(TestData.TVSHOW_ID, 1, null);
    ...
    public void test_videos() {
        Observable<Videos> videos = getManager().tvSeasonsService().videos(TestData.TVSHOW_ID, 1, null);
