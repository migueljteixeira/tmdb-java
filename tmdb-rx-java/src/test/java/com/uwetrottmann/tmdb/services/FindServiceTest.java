...
public class FindServiceTest extends BaseTestCase {
    ...
    public void test_find_movie() {
        Observable<FindResults> results = getManager().findService().find("tt0361748", ExternalSource.IMDB_ID, null);

        results.toBlocking().forEach(new Action1<FindResults>() {
            @Override
            public void call(FindResults results) {
    ...
    public void test_find_people() {
        Observable<FindResults> results = getManager().findService().find("nm0000093", ExternalSource.IMDB_ID, null);
    ...
    public void test_find_tv_show() {
        Observable<FindResults> results = getManager().findService().find("tt0903747", ExternalSource.IMDB_ID, null);
    ...
    public void test_find_tv_season() {
        Observable<FindResults> results = getManager().findService().find("30272", ExternalSource.TVDB_ID, null);
    ...
    public void test_find_tv_episode() {
        Observable<FindResults> results = getManager().findService().find("tt0959621", ExternalSource.IMDB_ID, null);
